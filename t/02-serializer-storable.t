...
is_deeply ([$serializer->serialize ('add', 'foo')],
           ['add', 'foo', 0],
...
is_deeply ([$serializer->serialize ('add', '17times3939')],
           ['add', '17times3939', 0],
           '->serialize should return the simple tuple since it is so short');
...
is_deeply ([$serializer->serialize ('add', $longstring)],
           ['add', $longstring, 0],
...
is_deeply ([$serializer->serialize ('add', $longref)],
           ['add', $longstorable, 1],
