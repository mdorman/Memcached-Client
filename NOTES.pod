...
C<$client-E<lt>get> calls the anonymous subroutine that was returned
when C<M::C::Request::Get-E<lt>generate> (which, due to inheritance,
is C<M::C::Request-E<lt>generate>) was called.
